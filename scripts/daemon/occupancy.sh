...
# （[`board-design.md`](../../agent-ops/board-design.md) 1.3節）。1回の一覧の走査で全部を見る。
#
...
#
# 溢れるより止まるほうが軽い、という向きは [`board-design.md`](../../agent-ops/board-design.md) 2.4節 と
...
# [`board-design.md`](../../agent-ops/board-design.md) 1.6節）。
#
# **問いは2つあり、答えが違う**（[`board-design.md`](../../agent-ops/board-design.md) 1.2節）。
# どちらを訊くかは呼び手が渡す。
#
