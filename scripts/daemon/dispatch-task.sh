...
#   bash scripts/daemon/dispatch-task.sh 1029 <補足ファイル> --bridge   # このPCで走らせる
#   DRY_RUN=1 bash scripts/daemon/dispatch-task.sh 1029 <補足ファイル>     # 渡す引数を見るだけ
#   DRY_RUN=full bash scripts/daemon/dispatch-task.sh 1029 <補足ファイル>  # 指示の本文も切らずに出す
#
