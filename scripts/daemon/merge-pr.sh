...
#
#   bash scripts/daemon/merge-pr.sh 1036
#
# 出力は1行1件。
...
# （[`board-design.md`](../../agent-ops/board-design.md) 2.10.1節）。
#
...
# 定義上もう済んでいる（[`board-design.md`](../../agent-ops/board-design.md) 2.13.1節）。**許可を引いて
