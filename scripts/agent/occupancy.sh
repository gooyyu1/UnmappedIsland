...
# （[`board-design.md`](../../agent-ops/board-design.md) 1.3）。1回の一覧の走査で全部を見る。
#
...
# [`board-design.md`](../../agent-ops/board-design.md) 1.6）。
#
# **問いは2つあり、答えが違う**（[`board-design.md`](../../agent-ops/board-design.md) 1.2）。
# どちらを訊くかは呼び手が渡す。
#
