...
| `UNLABEL` | 判定がどれも前の差分のものなのに、結論の札が残っている（[`board-design.md`](../agent-ops/board-design.md) 2.13.7） | **前の差分の札を落としてほしい**とPRへ頼む。**外すのは `board-labels.yml`**——盤面が自分で外すと、それが「人が外した」と読まれて `却下` が付きます |
