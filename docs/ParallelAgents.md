...
| `REVIEW` | 判定のラベルが無く、緑で、マージできると分かっている。**`直し待ち` で頼み終えても戻ってこないPRも**（[`board-design.md`](../agent-ops/board-design.md) 2.13.6）、**判定が書かれても札が付かないPRも**（同 2.13.7） | [`dispatch-review.sh`](../scripts/daemon/dispatch-review.sh) |
