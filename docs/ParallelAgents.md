...
| 種類 | 例 | 何のためか | 誰が書き換えるか |
| --- | --- | --- | --- |
| **人へ訊く** | `判断待ち` ラベル | **チェックを付けるだけで答えになる**問いを1本に1つ。**溜める一覧は持ちません**——答えが付いても誰も気づかないため（[#656](https://github.com/gooyyu1/UnmappedIsland/issues/656) がその形で、記録として残っています） | 気づいたセッションが立て、人間がチェックしてラベルを外す |
