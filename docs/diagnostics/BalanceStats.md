...
- **罠による狩り。** 獲物を返すのは操作ではなく `catch_remaining` の `on_shortfall`
  （時間で回る仕掛け）なので、所要時間を持つ工程として並べられない。
...
所要時間の `?` は、所要時間か分岐の重みが**定義だけでは決まらない**工程（相手の持ち物を見る
`{subject: dragged, prop: ...}` 参照など）。解けない重みは0として扱うので、その行の期待値は
残った候補へ寄っている——例えば `strike` の当たり方は武器が決めるため、ここでは出せない。

| 宣言元 | 工程 | 種別 | 所要（分） | 期待産出 | 値の増減 |
| --- | --- | --- | --- | --- | --- |
| monkey | turn | action | 0 | bite_wound ×0.15、gore_wound ×0.00 | — |
| monkey | strike | combination | 15 ? | laceration ×0.00、puncture_wound ×0.00 | （self）wariness +0.00、（self）shock +0.00 |
| monkey_carcass | butcher | combination | 60 | raw_meat ×4.00、animal_bone ×1.00、rawhide ×1.00 | — |
| junglefowl | turn | action | 0 | bite_wound ×0.00、gore_wound ×0.00 | — |
| junglefowl | strike | combination | 15 ? | laceration ×0.00、puncture_wound ×0.00 | （self）wariness +0.00、（self）shock +0.00 |
| rat | turn | action | 0 | bite_wound ×0.05、gore_wound ×0.00 | — |
| rat | strike | combination | 15 ? | laceration ×0.00、puncture_wound ×0.00 | （self）wariness +0.00、（self）shock +0.00 |
| wild_boar | turn | action | 0 | bite_wound ×0.00、gore_wound ×0.40 | — |
| wild_boar | strike | combination | 15 ? | laceration ×0.00、puncture_wound ×0.00 | （self）wariness +0.00、（self）shock +0.00 |
| wild_boar_carcass | butcher | combination | 240 | raw_meat ×40.00、animal_bone ×6.00、rawhide ×6.00 | — |
| junglefowl_carcass | butcher | combination | 20 | raw_meat ×1.00、feather ×1.00、small_bone ×1.00 | — |
| roasted_rat | eat | action | 0 | small_bone ×1.00 | satiety +60.00、protein +3.00、lipid +1.00 |
| raw_meat | eat | action | 0 | — | satiety +500.00、protein +20.00、lipid +4.00、vitamin +2.00 |
| roasted_meat | eat | action | 0 | — | satiety +450.00、protein +24.00、lipid +7.00 |
| charred_lump | eat | action | 0 | — | satiety +200.00、protein +4.00、lipid +1.00 |
| captain | wait | action | 15 | — | （self）stamina +2.00 |
| captain | rest | action | 60 | — | （self）stamina +10.00 |
| captain | nap | action | 180 | — | （self）stamina +36.00、（self）wakefulness +36.00 |
| captain | sleep | action | 360 | — | （self）stamina +90.00、（self）wakefulness +96.00 |
| engineer | wait | action | 15 | — | （self）stamina +2.00 |
| engineer | rest | action | 60 | — | （self）stamina +10.00 |
| engineer | nap | action | 180 | — | （self）stamina +36.00、（self）wakefulness +36.00 |
| engineer | sleep | action | 360 | — | （self）stamina +90.00、（self）wakefulness +96.00 |
| farmer | wait | action | 15 | — | （self）stamina +2.00 |
| farmer | rest | action | 60 | — | （self）stamina +10.00 |
| farmer | nap | action | 180 | — | （self）stamina +36.00、（self）wakefulness +36.00 |
| farmer | sleep | action | 360 | — | （self）stamina +90.00、（self）wakefulness +96.00 |
| medic | wait | action | 15 | — | （self）stamina +2.00 |
| medic | rest | action | 60 | — | （self）stamina +10.00 |
| medic | nap | action | 180 | — | （self）stamina +36.00、（self）wakefulness +36.00 |
| medic | sleep | action | 360 | — | （self）stamina +90.00、（self）wakefulness +96.00 |
| palm_tree | pick_green_coconut | action | 30 | green_coconut ×1.80、sprained_ankle ×0.10 | — |
| palm_tree | pick_frond | action | 30 | palm_frond ×2.70、sprained_ankle ×0.10 | — |
| green_coconut | bore | combination | 15 | drained_green_coconut ×1.00 | satiety +60.00、carbohydrate +2.00、vitamin +5.00、hydration +20.00 |
| drained_green_coconut | split | combination | 15 | coconut_jelly ×2.00 | — |
| coconut_jelly | eat | action | 0 | — | satiety +150.00、carbohydrate +4.00、lipid +1.00、vitamin +5.00、hydration +5.20 |
| coconut | husk | combination | 30 | husked_coconut ×1.00、coconut_husk ×1.00 | — |
| coconut_husk | light | combination | 30 | burning_tinder ×0.71 | — |
| husked_coconut | crack | combination | 15 | coconut_half ×2.00 | — |
| husked_coconut | pry_open | combination | 15 | coconut_half ×2.00 | — |
| coconut_half | scrape | combination | 30 | coconut_meat ×1.00、coconut_bowl ×1.00 | — |
| coconut_meat | eat | action | 0 | — | satiety +200.00、carbohydrate +4.00、protein +3.00、lipid +26.00、vitamin +7.00、hydration +6.00 |
| woven_basket | woven | recipe | 120 | woven_basket ×1.00 | — |
| abaca | fell | combination | 20 | banana_stem ×5.00 | — |
| banana_plant | fell | combination | 20 | banana ×2.00、banana_stem ×2.00 | — |
| banana | eat | action | 0 | — | satiety +350.00、carbohydrate +10.00、vitamin +35.00 |
| banana_stem | strip | combination | 30 | plant_fiber ×2.00 | — |
| plant_fiber | light | combination | 30 | burning_tinder ×0.67 | — |
| plant_fiber | spin | combination | 20 | yarn ×1.00 | — |
| yarn | ply | combination | 20 | cord ×1.00 | — |
| rope | twisted | recipe | 60 | rope ×1.00 | — |
| fire_drill | carved | recipe | 60 | fire_drill ×1.00 | — |
| dry_grass | light | combination | 30 | burning_tinder ×0.60 | — |
| campfire | add_fuel | combination | 1 | — | （self）fuel +999.00 |
| campfire | add_stone | combination | 5 | — | （self）stones +1.00 |
| campfire | stacked | recipe | 15 | campfire ×1.00 | — |
| three_stone_hearth | add_fuel | combination | 1 | — | （self）fuel +999.00 |
| three_stone_hearth | add_stone | combination | 5 | — | （self）stones +1.00 |
| stone_hearth | add_fuel | combination | 1 | — | （self）fuel +999.00 |
| water_spinach | eat | action | 0 | — | satiety +300.00、carbohydrate +1.00、vitamin +83.00 |
| coconut_crab | eat | action | 0 | — | satiety +500.00、protein +25.00、lipid +8.00、vitamin +2.00 |
| taro | eat | action | 0 | — | satiety +600.00、carbohydrate +40.00、protein +2.00、vitamin +36.00 |
| jar | collect_rain | action | 0 | water_liquid ×1.00 | — |
| coconut_bowl | collect_rain | action | 0 | water_liquid ×1.00 | — |
| water_liquid | drink | action | 0 | — | hydration +10.00、（self）volume -250.00 |
| tea_liquid | drink | action | 0 | — | hydration +10.00、wakefulness +2.00、（self）volume -250.00 |
| stone | knap | combination | 60 | sharp_stone ×1.00 | — |
| sandy_beach | explore | action | 15 | palm_tree ×0.13、woven_basket ×0.05、coconut_crab ×0.29、coconut ×0.91、thick_branch ×0.67 | （self）exploration_progress +1.00 |
| rocky_coast | explore | action | 15 | cave_entrance ×0.13、coconut_crab ×0.39、stone ×1.25、thick_branch ×0.28 | （self）exploration_progress +1.00 |
| cliff_coast | explore | action | 15 | cave_entrance ×0.20、stone ×1.13、thick_branch ×0.25 | （self）exploration_progress +1.00 |
| grassland | explore | action | 15 | berry_bush ×0.13、spring ×0.09、water_spinach ×1.01、taro ×0.71、dry_grass ×0.11 | （self）exploration_progress +1.00 |
| forest | explore | action | 15 | berry_bush ×0.22、spring ×0.09、twig ×1.33、taro ×0.29、banana_plant ×0.11 | （self）exploration_progress +1.00 |
| jungle | explore | action | 15 | palm_tree ×0.12、taro ×0.18、twig ×0.57、coconut ×0.73、water_spinach ×0.25、abaca ×0.10、banana_plant ×0.08 | （self）exploration_progress +1.00 |
| rocky_field | explore | action | 15 | cave_entrance ×0.18、twig ×0.58、stone ×1.29 | （self）exploration_progress +1.00 |
| wasteland | explore | action | 15 | stone ×1.01、twig ×0.51、dry_grass ×0.11 | （self）exploration_progress +1.00 |
| mountainside | explore | action | 15 | cave_entrance ×0.15、berry_bush ×0.22、stone ×1.03、twig ×0.65 | （self）exploration_progress +1.00 |
| mountain_peak | explore | action | 15 | cave_entrance ×0.37、stone ×1.21 | （self）exploration_progress +1.00 |
| snare | add_plant_bait | combination | 1 | — | （self）plant_bait +999.00 |
| snare | add_meat_bait | combination | 1 | — | （self）meat_bait +999.00 |
| snare | knotted | recipe | 30 | snare ×1.00 | — |
| palm_frond | weave | action | 90 | woven_leaf ×1.00 | — |
| palm_frond | split_and_weave | combination | 60 | woven_leaf ×2.00 | — |

## 3. 連鎖表（素材から摂取までの総時間）

1日ぶんの必要量は medic のもの（消費表の常時効く減りから）。
「1日の割合」は、1日ぶんを賄うのに要る時間が1日（1440分）に占める割合。
...
| 経路 | 1単位あたり（分） | 探索 | 加工 | 1日ぶん（分） | 1日の割合 | 同時に返す値 | 前提 |
| --- | --- | --- | --- | --- | --- | --- | --- |
