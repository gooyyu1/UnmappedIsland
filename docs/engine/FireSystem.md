...
何度も試して火口を使い切ることにはなりません。条件の葉 2 つは 8 節の炉の雨と同じもので、あちらは
火力を削り、こちらは可否を閉じます。
...
**火が与えるものは 2 通りです。** 炉から取り出せる産物（焼け石、9.1 節）と、置かれた場所へ届くもの
...
こととして挙げている残り 2 つ——種火を保つことと高温を出すこと——を持つのは**炉の側**で、保つ長さは
