...
カードを薄く敷く仕組み（[`CardView.md`](../ui/CardView.md) 11 節）が、**枠によって受け入れの宣言が
違うスロットで働く**ので、器を載せられる炉——三石のかまどと石囲いの炉——だけがこれを出します。
焚き火はどの枠も直火の枠なので、名乗っても並びが既に言っていることの繰り返しにしかなりません。
