...
[`ContentSkeleton.md`](../world/ContentSkeleton.md) 8.1.4節・8.1.5節が持ちます。**2つが重なって
いることは`tests/world-codex/stormOutdoors.test.ts`が全数で見張る**ので、片方だけを書いた操作は
そこで落ちます。上の「書きません」の側も同じで、粗い動作と海を渡ることは風雨でも止まりません。
