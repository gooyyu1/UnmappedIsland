...
怪我なのか（1 節）、傷の重さをどう刻むか（2 節）、手当てをどう成立させるか（3 節）を決めます。
...
`treatment` スロット（治療具を1つ当てる枠）だけで成り立ちます。
...
出血（[`VitalsSystem.md`](./VitalsSystem.md) 4 節。当てている間だけ、傷が命を削るブロックのゲートを
閉じる）の3つです。それぞれの得意・不得意は次のように置きます。
...
- 感染。放置した傷が別の傷へ悪化する経路と、その入口をどこに置くか
