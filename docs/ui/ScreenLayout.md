...
各レーンには全面に絵を敷きます（`src/game/ui/laneArt.ts`）。置き場所は 2 通りです。

| レーン | 置き場所 | 何を描くか |
|--------|----------|-----------|
| ロケーション | `src/assets/lanes/location/<土地の object_def の識別子>.png` | その土地の眺め |
| フィールドアイテム | `src/assets/lanes/field_item/<土地の object_def の識別子>.png` | その土地の地面 |
| ハンド | `src/assets/lanes/hand.png` | プレイヤーの手 |
