...
- **地面とカードの両方を歪ませます。** 砂だけではまっすぐな輪郭が無く、ゆらいでいることが読み取れま
  せん。カードの縁という直線が一緒に波打って、初めて陽炎に見えます。
- **ゆらぎはレーンの上の位置で決めます。** 地面とカードには別々にフィルタを掛けることになりますが、
  どちらもレーンの矩形を1枚の空気として見るので、同じ位置なら同じだけ揺れます。カードを送っても
  空気は動かず、カードがその中を通っていきます。
