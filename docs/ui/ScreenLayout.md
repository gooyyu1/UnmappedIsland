...
薄くするのは、**束を丸ごと持ち出して場所が空いた**元のカードだけです（1 枚しか映していないカードを
掴んだとき、または待って束が全部ついてきたとき）。そこに残っているのはもう札ではなく、返ってくる場所を
示す姿だからです。
...
**ついてきたぶんは、元の束から減って見えます。** 掴んだ 1 枚ぶんは元のカードが場所に残ったまま
（前項）なので、減るのは 2 枚目以降です。
