...
通した合計は620分**（刃物ありの140分＋480分）——1日ぶんの自由時間
（[`ContentSkeleton.md`](./ContentSkeleton.md) 8節）の大半を使う量です。

| 完成品 | 直接の材料 | 工程 | 素材から通した時間 |
| ------ | ---------- | ---- | ------------------ |
| 寝床 | 編んだ葉 ×3 | 20分 | 素手で290分／刃物があれば140分 |
| 寝台の骨組み | 太い枝 ×6、紐 ×3 | 180分 | ＋約480分（うち紐に300分） |
| ハンモック | 紐 ×5 | 120分＋吊るのに20分 | 約640分（うち紐に500分） |
...
- **ハンモックは、段1と段2を通した手間とほぼ並びます**（620分に対して640分）。**同じだけ戻すのに、
