...
**確定度と実装状況。** 検討結果であり、**確定しているのは 4.2.1 節（詰め物まで仕上げれば、最も寒い土地の
夜も火なしで越せる）だけ**です。**入っているのは敷物（2節の段1）・骨組み
...
**寝床を詰め物まで仕上げた者は、島でいちばん寒い土地の夜を火なしで越せます。** 詰め物を作ることが、
夜通し火を守る仕事から抜ける道になります。

**火だけに残す道は採りません。** 残すと、寝床をどこまで良くしても最も寒い土地の夜には炉が要り、
寝床の段は「火の要る夜を減らす」ところで止まります。**火の要らない夜を寝床が作れる**ことが、
手間の重い詰め物（5節）まで通す理由になります。

どれだけ押し下げてそこへ届かせるかは上の表が持ちます。**越せる／越せないが、寝床へ差せる部品が骨組み
だけかどうかと一致すること**は `tests/world-codex/landTemperature.test.ts` が見張ります——差せる部品を
足して押し下げを足さなければ落ちます。**枠の受け入れ宣言で引く**ので、詰め物をどのタグで名乗らせても
同じに掛かります。
