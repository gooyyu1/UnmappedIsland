...
どれだけ押し下げてそこへ届かせるかは上の表が持ちます。**越せる／越せないが詰め物の有無と一致すること**は
`tests/world-codex/landTemperature.test.ts` が見張ります——詰め物を世界へ足して押し下げを足さなければ
落ちます。
...
蒸れるので、袋を何で作るかは詰め物を物として置くときに決めます——**段そのものは置くと決まりました**
（4.2.1節）。詰め物は湿気を吸って固まり黴びるので、天日に
