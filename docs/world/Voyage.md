...
**そりを引けば2本まで一度に運べます**（[`Containers.md`](./Containers.md) 2節）。往復は半分で済みますが、
...
- 小島へのアーティファクトの配置（[`ContentSkeleton.md`](./ContentSkeleton.md) 6 節）。小島は上陸して
  ...
  決まってから（下の項）。
- 丸太を3本以上まとめて運ぶ手段（1 節）。そりで2本、台車で2本までは入った（[`Containers.md`](./Containers.md)
  2節）が、筏1つの6本を1往復で運ぶ手立ては無い。積める重さを上げるのか、往復そのものを短くするのかは
  決めていない。
