...
**3〜4 つ**。**そこへもう 1 つ足します**——足す理由は下の蒸発です。

- **足りなくなる筋は、飲み過ぎではなく蒸発です。** 甕は口を開けたままなので、日なたに置いた中身は
  1 日 273mL<!-- stats: balance.yaml rain_water container=jar season=dry evaporation_ml_per_day -->
  （乾季。雨季でも 61mL<!-- stats: balance.yaml rain_water container=jar season=wet evaporation_ml_per_day -->）
  ずつ減ります（[`LiquidContainerSystem.md`](../engine/LiquidContainerSystem.md) 6 節）。**1 日ぶんの
  およそ 1 割が、水の入っている甕 1 つにつき飲まれずに消えます**——海区は樹冠も影も持たないので
  （3.10 節）、日陰へ寄せて減らすこともできません。**空になった甕は減りません**（中身の軸ごと落ちる、
  同 1 節）ので、消えるのは 6 日でおよそ 1 つぶんです。
- **重さは効きません。** 満たした甕は 5.2kg（器 1.2kg ＋ 水 4kg）なので、5 つでも 26kg——**積荷の段が
  上がる 80 kg**（3.2 節）**には、生肉 12〜18 個**（6〜9kg、3.9.3 節）**と合わせても届きません。**
  かさの側も、筏の 500 L に対して甕 1 つが 15 L です。
