...
1.75 区間<!-- stats: voyage_storm.yaml storm_cost coast=sandy_beach season=wet extra_legs -->、
...
（3.8 節）。砂浜から近道で渡ると
5.51 日<!-- stats: voyage_storm.yaml course_storm coast=sandy_beach season=dry mean -->と
6.34 日<!-- stats: voyage_storm.yaml course_storm coast=sandy_beach season=wet mean -->、最も短い岸壁
からでも
3.73 日<!-- stats: voyage_storm.yaml course_storm coast=cliff_coast season=dry mean -->と
4.38 日<!-- stats: voyage_storm.yaml course_storm coast=cliff_coast season=wet mean -->で、
**差は 0.7〜0.8 日です。**
...
8.23 日<!-- stats: voyage_storm.yaml course_storm coast=sandy_beach season=wet p95 -->を超え、最も長い
回は
12.02 日<!-- stats: voyage_storm.yaml course_storm coast=sandy_beach season=wet max -->かかりました
——**平均が 1 日も動かないのに裾は 5 日以上伸びる**ので、雨季に出ることの代償は日数の期待値ではなく、
...
雨季は 0.88 回<!-- stats: voyage_storm.yaml sweeps coast=sandy_beach season=wet backwards -->島の側へ、
0.44 回<!-- stats: voyage_storm.yaml sweeps coast=sandy_beach season=wet forwards -->本土の側へ流され、
...
1.31 回<!-- stats: voyage_storm.yaml sweeps coast=sandy_beach season=wet voided_crossings -->——押し流しは
...
**3 節の網から出る所要時間は、近道なら素の速さで 4〜6 日、遠回りでも 7 日ほどです。** 各海区で航路が現れるまでの見張り（3 節の表）と、
...
一方、**20 回に 1 回は 8 日を超えます**（3.1 節）。**「4〜6 日」は乾季に出た場合の話**で、雨季に
