...
——海区は樹冠も地面の反射も持たないので、明るさは空そのもので、島の砂浜と同じだけ夜は暗くなります。

**釣りと海鳥は、嵐でも止まります。** 屋根の下でない場所での採取だからで、そこは既に決まっています
（[`ContentSkeleton.md`](./ContentSkeleton.md) 8.1.4 節）。**見張りだけは止まりません**——嵐が止めるのは
採取で、探索はその外だからです。

**渡ることには明るさが要りません**（3 節）。だから夜の海は空白にならず、**明るいうちに見張って漁り、
暗くなったら渡る**という組み立てになります
（[`DesignPrinciples.md`](../concept/DesignPrinciples.md) の「時間経過に任せる区間を作らない」節）。
**所要日数（3.9.1 節）は変わりません**——1 航海ぶんの見張りは横断よりずっと短く、明るい時間に収まります。

**明かりを持ち込めば、夜でも同じ手が通ります**（松明。
[`IlluminationSystem.md`](../engine/IlluminationSystem.md) 3 節）。止めているのは夜そのものではなく
明るさで、**そこは島と同じです。**
