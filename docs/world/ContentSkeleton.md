...
日数にして69.10日<!-- stats: terrain.yaml work_piles_total days -->ぶんです。**
...
**この69.10日<!-- stats: terrain.yaml work_piles_total days -->は、明るさと移動時間を無視した下限です**——どちらも入れると同じ山が
...
| 11 | 船と海図 | — | **筏（4.6<!-- stats: terrain.yaml work_piles pile=筏 days -->・実測）**／**帆（3.4<!-- stats: terrain.yaml work_piles pile=帆 days -->・実測）**／櫂と舵（2<!-- stats: terrain.yaml work_piles pile=櫂と舵 days -->）／沿岸航海（3<!-- stats: terrain.yaml work_piles pile=沿岸航海 days -->）／海図を仕上げる（5<!-- stats: terrain.yaml work_piles pile=海図を仕上げる days -->） | 5<!-- stats: terrain.yaml work_piles_by_system system=11 piles --> | 18.0<!-- stats: terrain.yaml work_piles_by_system system=11 days --> |
| 12 | 家具・娯楽 | — | **設えを積んで里心を止める（1.60<!-- stats: terrain.yaml work_piles pile=設えを積んで里心を止める days -->・実測）** | 1<!-- stats: terrain.yaml work_piles_by_system system=12 piles --> | 1.60<!-- stats: terrain.yaml work_piles_by_system system=12 days --> |
| | | | **合計** | **27**<!-- stats: terrain.yaml work_piles_total piles --> | **69.10**<!-- stats: terrain.yaml work_piles_total days --> |
...
1周回は約106日<!-- stats: terrain.yaml cycle base=shortest_mean metric=total_days mean ±1 -->です。1日927分<!-- stats: terrain.yaml daily_budget surplus -->という自由時間は上限であって、実際に使える時間ではありません。**
...
時間は1日927分<!-- stats: terrain.yaml daily_budget surplus -->。4節の山の合計は約64,100分<!-- stats: terrain.yaml work_piles_total minutes ±100 -->なので、
**そのまま割れば69.10日ぶん**<!-- stats: terrain.yaml work_piles_total days -->です。しかしこの927分<!-- stats: terrain.yaml daily_budget surplus -->は、
...
（約42,700分<!-- stats: terrain.yaml work_piles_total outdoor_minutes ±100 -->）、拠点での加工を1/3
...
59日ぶん<!-- stats: terrain.yaml work_piles_total base_days -->なので、約106日<!-- stats: terrain.yaml cycle base=shortest_mean metric=total_days mean ±1 -->の中に余裕で収まります。**夜が足りなくなることはなく、
足りないのは昼です。**
