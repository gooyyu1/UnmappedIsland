...
**手段の側は、住居とだけ重なります。** 雨風のために建てた家も居心地を押しますが
（[`Dwellings.md`](./Dwellings.md) 2.1節）、部品の合計は `homely` 止まりに抑えてあります。
**`snug` を払えるのはこの系統の物だけで、それらは据えること以外に何の役にも立ちません**
——生きるのに要る物が居心地を兼ねると、対策がどうせ作る物になって圧が素通りするためです（同節）。
