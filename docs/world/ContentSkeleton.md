...
ためです——寒さと雨は熱が受け持っているので、火を焚いても里心は1点も減りません。

**この系統の物は、据えること以外に何の役にも立ちません。** 生きるのに要る物が居心地を兼ねると、
対策がどうせ作る物になって圧が素通りするためです（同節）。**住居だけは例外で、雨風のために建てた家も
居心地を押します**——ただし部品の合計は `homely` 止まりに抑えてあり
（[`Dwellings.md`](./Dwellings.md) 2.1節）、`snug` を払えるのはこの系統の物だけです。
