...
| --- | --: | --: | --: | --: | --: | --: | --: | --: | --: | --: | --: |
| 07-18 | 4,337 | 4,300 | 2,074 | 63 | 0 | 18 | 48 | 8.9ファイル / 610行 | 29,300 | $34（1本 $0.7・千行 $1.2） | 29% |
...
| 09-07 | 49,241 | 59,187 | 26,464 | 20,405 | 12,019 | 645 | 1,113 | 9.5ファイル / 303行 | 41,790 | $3,238（1本 $23.5・千行 $77.5） | 55% |
...
**表の最後の区間（09-04〜09-07）では 9.5ファイル・303行へ戻っています。** この区間の138本を、
**盤面を作り直すもの**（`.claude/**`・`scripts/**`・`.github/**` を触る53本）と**それ以外**（85本）で
割ると、**10.0ファイル・430行 対 9.2ファイル・224行**。
...
下がっています。** 表の段で見ても、1本あたりが $20.4 から $23.5 へ上がったのは**1本が 203行から
303行へ大きくなったから**で、**動かした行で見た値段（$100.2 → $77.5）はむしろ下がっています。**
...
**それでも1本あたりの値段は下がっていません。** 09-05〜09-07 は区間で **$23.5**
