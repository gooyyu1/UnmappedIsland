...
| 08-01 | 15,506 | 11,381 | 5,498 | 1,851 | 48 | 213 | 14.4ファイル / 857行 | $1,270（1本 $14.9） | 60% |
| 08-13 | 26,885 | 18,583 | 9,000 | 3,151 | 51 | 388 | 10.3ファイル / 305行 | $2,108（1本 $12.0） | 70% |
...
| 09-07 | 49,076 | 58,374 | 20,015 | 12,514 | 637 | 1,090 | 9.7ファイル / 302行 | $3,037（1本 $27.6） | 52% |
...
並列化してからは **5〜6ファイル・200〜250行**です。**1本が3〜4分の1になっているので、本数が
...
**9月の区間では 9〜10ファイル・300行へ戻っています。** 09-04〜09-07（日本時間）に `main` へ
入ったPRを、**盤面を作り直すもの**（`.claude/**`・`scripts/agent/**`・`scripts/usage/**`・
`.github/**` を触る45本）と**それ以外**（90本）で割ると、**10.2ファイル・441行 対
9.3ファイル・229行**。**行数は倍近く違うのに、ファイル数はほとんど変わりません。**
