...
| 09-07 | 49,241 | 59,011 | 26,452 | 20,405 | 11,833 | 645 | 1,112 | 9.5ファイル / 299行 | 41,003 | $3,238（1本 $23.6・千行 $79.0） | 55% |
...
**$11〜$15** の間を動いていましたが、**08-27〜08-30 の区間で $20.4** へ跳ねています。
**レビューを別のセッションへ出したのがこの区間**（08-29 21:38）で、日ごとに見ると
**08-28 の $10.8 から 08-30 の $29.0** まで上がりました（第6期の「往復1周の値段」）。

**その後も下がっていません。** 司令塔を廃した後（第7期）の 09-05〜09-07 は区間で **$23.6**。
**1本 $167 の司令塔が丸ごと消えても、1本あたりは上がっています**——消えたぶんは、下の内訳で
別のところへ移っています。

**ただし1本あたりは、値段と粒度が混ざった数です。** PRの粒はこの期間で動いている（上の
「PRの数も、単独では読めません」）ので、**同じ額でも1本が小さければ1本あたりは下がります。**
動かした行で割ると別の形が出ます——**変更1千行あたりは、08-30 の $100.2 から第7期の $79.0 へ
下がっています。** 1本あたりが $20.4 から $23.6 へ上がったのは、**1本が 203行から 299行へ
大きくなったから**で、**動かした行で見た値段はむしろ下がっている**ということです。
...
**それでも1本あたりの値段は下がっていません。** 09-05〜09-07 は区間で **$23.6**
（末日は測った時点でまだ走っているセッションがあるので、下側の値）。司令塔が居た 08-27〜08-30 の
**$20.4** より高く、日ごとに見ても 08-30 の **$29.0** に対して 2割ほど低いだけです。**移った先は
`bridge`**——このPCで人間が開いた
