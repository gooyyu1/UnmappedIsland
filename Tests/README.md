...
├── StreamingAssets/
│   └── WorldCodex/            # Assets/StreamingAssets/WorldCodex 実ファイル検証（本ドキュメント「StreamingAssets/WorldCodex テスト」節を参照）
└── Domain/
...
### StreamingAssets/WorldCodex テスト（`Tests/StreamingAssets/WorldCodex/`）
...
- `Assets/StreamingAssets/WorldCodex` の実ファイル内容を確認したい場合は `Tests/StreamingAssets/WorldCodex/` に追加する。
