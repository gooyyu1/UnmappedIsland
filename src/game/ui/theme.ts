...
export const SIZE = {
  ...
  conditionButton: 48,
  /**
   * 地図・装備・怪我のボタンに載せるアイコンを収める枠。ボタン（211×98u）の中央へ置く。
   *
   * **正方形にしない。** 絵は縦横比のままこの枠へ収めるので、正方形にすると、地図のような平たい物が
   * 高さの半分しか使えず、丸い物より小さく見えてしまう（開いた地図が巻いた包帯より小さく見えた）。
   * ボタンと同じ横長にすると、どの絵も高さで揃い、幅だけが物の縦横比のぶん伸びる。
   */
  slotButtonIcon: { width: 168, height: 72 },
  radius: 12,
  /**
