...
| オプションバー高（縦型） | 96 |
| フィルターバー高（縦型、内容量に応じた自動） | 約 120（アイコンボタン 88 + 上下パディング 16×2） |
| 右サイドバー幅（横型、オプション／フィルター共有） | 172 |
...
（キャラクターエリアの直上）に高さ 96u の横長バーとして置きます。横型ではフィールド
エリア右のサイドバー上段に置き、アイコンボタンを縦に並べます（下段はフィルターバー、
サイドバーの詳細は次項）。
...
左にダッシュボード列、中央にフィールドエリア、右に幅 172u のサイドバー（オプション／
...
| フィールドエリア | 1208 × 1080（カード 6 枚分強の横幅） |
| 右サイドバー | 172 × 1080（上段: オプションバー、下段: フィルターバー） |
