...
| 向き | 解像度 | フィールドエリア | キャラクターエリア | オプションエリア |
|------|--------|----------------|-----------------|----------------|
...
キャラクターの状態・天候・日時などのゲーム情報と、ゲーム操作ボタンを集約します。
**キャラクターエリア**と**オプションエリア**で構成されます。

#### キャラクターエリア (Character Area)

天候・日付/時刻・キャラクターカード・ステータスバーを配置するエリアです。
プレイヤーが自分のキャラクター状況を把握するための情報が集まります。
